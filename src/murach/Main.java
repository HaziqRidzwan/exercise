...
public class Main {
	...
	public static void main(String[] args) {
		...
		String choice = "y"; // if y, program continues looping
		while (choice.equalsIgnoreCase("y")) {

			// get input from user
			System.out.print("Enter monthly investment: ");
			double monthlyInvestment = Double.parseDouble(sc.nextLine()); //parse means convert data to other format
			...
			double futureValue = 0; //futureValue starts from zero
			int i = 1;
			while (i <= months) {
